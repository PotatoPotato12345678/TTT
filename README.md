...
changing the version of python
```
# confirm the version of python
py -0p
```
```
# install scipy into python 3.12-32
py -3.12-32 -m pip install scipy
# check packages about python 3.12-32
py -3.12-32 -m pip list
```
in environment setting, set PYTHON_PY = specified version
